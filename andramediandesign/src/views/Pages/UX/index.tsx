      ...
      >
        ...
        <Grid item xs={6}>
          <Typography variant="body1">
            ...
            build game. The top of the product houses a touch and distance
            sensitive interface that along with AI voice operated system will be
            the way in which the user engages with the product. Within the
            product will be a small AR city projected from the base, this AR
            city will be built and managed by the user.
          </Typography>
        </Grid>
        <Grid item xs={12}>
        ...
        <Grid item xs={6}>
          <Typography variant="body1">
            ...
            through education in an effort to aid against biodiversity loss and
            animal extinction.
          </Typography>
          <br />
          <Typography variant="body1">
          ...
          <Typography variant="body1">
            ...
            subsequent storyboards that aided the problem space and successfully
            met design criteria.
          </Typography>
          <br />
          <Typography variant="body1">
        ...
        >
          ...
          <Grid item xs={6}>
            ...
            lifestyle and how they could lower their impact on the environment.
            These improvements will be set to the user as challenges, these
            challenges were designed with gamification in mind, engaging the
            user and investing them in the experience as a whole.
          </Grid>
        </Grid>
        <Grid item container spacing={4} xs={12} style={{ paddingTop: "160px" }}>
          <Grid item xs={6}>
